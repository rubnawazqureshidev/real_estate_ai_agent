        ...
        <div class="container">
            <nav class="nav-wrapper">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li class="nav-item"><a href="#roi-calculator" class="nav-link">ROI Calculator</a></li>
                    <li class="nav-item"><a href="#pricing" class="nav-link">Pricing</a></li>
                    <li class="nav-item"><a href="#faq" class="nav-link">FAQ</a></li>
                    <li class="nav-item"><a href="#contact" class="nav-link">Contact</a></li>
                    <li class="nav-item nav-item-cta">
                        <a href="#contact" class="btn btn-primary btn-header">Get Free Demo</a>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column footer-about">
                    <div class="footer-logo">
                        ...
                        <span class="footer-logo-text">Real Estate AI Agent</span>
                    </div>
                    <p class="footer-description">
                        Empowering real estate agencies with intelligent AI automation. Qualify leads, book appointments, and scale your business 24/7.
                    </p>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-contact">
                        <li>
                            ...
                            <span>123 Real Estate Ave<br>Suite 100, City, ST 12345</span>
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <li>
                            ...
                            <span>info@realestateai.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-content">
                    <p class="footer-copyright">&copy; <?php echo date('Y'); ?> Real Estate AI Agent. All rights reserved.</p>
